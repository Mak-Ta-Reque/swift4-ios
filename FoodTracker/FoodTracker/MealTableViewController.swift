...
//  FoodTracker
//
//  Created by Md Abdul Kadir on 26.03.18.
...
class MealTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        // Table view cell are reused and shouldbe dequeued using a cell identifier.
    ...
    */
    ...
    private func loadSampleMeals() {
        ...
        guard let meal1 = Meal(name: "Caprese Salas", photo: photo1, rating: 4) else {
            fatalError("Unable to initilize meal1")
        }
        guard let meal2 = Meal(name: "Chicken and Potatoes", photo: photo2, rating: 5) else {
            fatalError("Unable to initilize meal2")
        }
        guard let meal3 = Meal(name: "Pasta with Meatballs", photo: photo3, rating: 3) else {
            fatalError("Unable to initilize meal3")
        }
